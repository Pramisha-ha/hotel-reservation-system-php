...
<body>
    ...
    <div class="roombooktable" class="table-responsive-xl">
        ...
        <table class="table table-bordered" id="table-data">
            ...
            <tbody>
            <?php
            $roombooktablesql = "SELECT rb.*, h.hotel_name FROM roombook rb 
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($res['hotel_name'] ?? 'N/A') ?></td>
                    ...
                    <td>Rs<?php echo number_format($res['total_price'] ?? 0, 2) ?></td>
